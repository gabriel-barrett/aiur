# Scalar compiler correctness

This document records the preserved field-only implementation and proofs in `Aiur.Scalar`.
The current tuple language and its proof status are recorded in [correctness](correctness.md).
...
[Aiur/Scalar/Semantics.lean](../Aiur/Scalar/Semantics.lean) defines these as mutually inductive
...
[Aiur/Scalar/Circuit/Derivation.lean](../Aiur/Scalar/Circuit/Derivation.lean) implements this
...
[Aiur/Scalar/Correctness.lean](../Aiur/Scalar/Correctness.lean) defines
...
[Aiur/Scalar/Semantics/WithCalls.lean](../Aiur/Scalar/Semantics/WithCalls.lean) defines
...
[ExpressionCorrectness.lean](../Aiur/Scalar/Circuit/ExpressionCorrectness.lean) is complete
...
[Selectors.lean](../Aiur/Scalar/Circuit/Selectors.lean) proves that an active selector
...
[CompileFacts.lean](../Aiur/Scalar/Circuit/CompileFacts.lean) connects those conditions to
...
[WitnessBasic.lean](../Aiur/Scalar/Circuit/WitnessBasic.lean) proves that extending a
...
[InactiveCorrectness.lean](../Aiur/Scalar/Circuit/InactiveCorrectness.lean) proves
...
[MatchWitness.lean](../Aiur/Scalar/Circuit/MatchWitness.lean) proves
...
[WitnessCorrectness.lean](../Aiur/Scalar/Circuit/WitnessCorrectness.lean) uses these
...
[LocalCorrectness.lean](../Aiur/Scalar/Circuit/LocalCorrectness.lean) lifts the expression
...
[Aiur/Scalar/EvalCorrectness.lean](../Aiur/Scalar/EvalCorrectness.lean) proves its agreement with
